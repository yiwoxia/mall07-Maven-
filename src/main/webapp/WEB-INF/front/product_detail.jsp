...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctx }/resources/front/css/base_detail.css" />
		<script type="text/javascript" src="${ctx }/resources/front/js/jquery.jqzoom.js"></script>
		<script type="text/javascript">
		$(function(){
			var subImagStr = '${product.subImages}';
			var strs = new Array();
			/*将subImagStr存入到数组里面split进行隔开  */
			strs = subImagStr.split(",");
			var int = 0;
			for (int = 0; int < strs.length; int++) {
				/* 对应的Id然后后面进行拼接付给smallShop上，append() 方法在被选元素的结尾插入指定内容。 */
													/* 一个属性 */			/* 路径 */	  /* 调取数组里面这是第几个 */ 		/* 触发的事件 */
		...
		<script type="text/javascript" src="${ctx}/resources/front/js/base.js"></script>
	</head>
	...
	<body>
		...
		<div class="menu">
			<div class="menu_center">
				<ul class="menu_ul">
					<li>
						<a class="all_a" href="${ctx }/search/search.shtml">全部商品分类</a>
					</li>
					<li>
						<a class="current" href="${ctx }/index.shtml" method="post">商城首页</a>
					</li>
					<li>
						<a href="">手机首页</a>
					</li>
		...
		<div class="banner_center">
			<div class="left">
				...
				<%-- 	<li class="banner_center_left_top" id="preview">
						<span class="jqzoom">
							<img src="${product.fullUrl}" style="width:350px;height:300px;" />
						</span>
					</li>
...
<!--产品参数开始-->
  <div>
    <div id="preview" class="spec-preview"> <span class="jqzoom"><img width="350px" height="350px" jqimg="" src="${product.fullUrl}" /></span> </div>
    <!--缩图开始-->
				...
				<ul>
					...
					<li class="right_bottom">
						...
						<ul class="right_bottom_btn">
							<li>
								<input class="right_bottom_substract" type="button" onclick="submite()" value="-" />
