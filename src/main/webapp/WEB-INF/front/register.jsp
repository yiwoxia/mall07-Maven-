		...
		<script type="text/javascript">
			$(function() {
				$("#username").blur(function() {
					...
					$.ajax({
						url : "${ctx}/register/checkUsername.shtml",
						type : "post",
			...
			$(function() {
				$("#submits").bind("click", function(event) {
					if ($("#repassword").val() != $("#password").val()) {
						$("#repasswordSpan").html("两次密码不一致");
						$("#repasswordSpan").css("color", "red");
						return false;
					...
					<div class="register">
						<ul>
							<li class="register_title_1">
								...
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已有账号<a style="color: #F41443;" class="here" href="${ctx }/login/login.shtml">在此登录</a></span>
							</li>
							<li>
