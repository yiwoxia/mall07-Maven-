...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/Java1707Mall/resources/front/css/base_detail.css" />
		<script type="text/javascript" src="/Java1707Mall/resources/front/js/jquery.jqzoom.js"></script>
		...
		$(function() {
			...
			function addCart(productId) {
				var amount = $("#num").val();
				window.location.href="/Java1707Mall/cart/addCart.shtml?productId="+productId+"&amount="+amount;
			}
		</script>
		<script type="text/javascript" src="/Java1707Mall/resources/front/js/base.js"></script>
	</head>
	<body>
		<!--top-->
		...
		<div class="logo_center">
			<div class="left">
				<a href="/Java1707Mall/index.shtml">
		...
		<div class="menu">
			<div class="menu_center">
				<ul class="menu_ul">
					<li>
						<a class="all_a" href="/Java1707Mall/search/search.shtml">全部商品分类</a>
					</li>
					<li>
						<a href="/Java1707Mall/index.shtml" target="_blank">商城首页</a>
					</li>
					<li>
						<a href="">手机首页</a>
					</li>
